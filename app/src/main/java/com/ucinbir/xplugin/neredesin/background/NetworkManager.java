...
public class NetworkManager {
	...
	public static String profilKaydet(Profil profil) {
		...
		try {
			...
			HttpPost request = new HttpPost(BaseActivity.NEREDESIN_PROFIL_KAYDET_URL);
	...
	public static List<Profil> arkadasSorgula(String kullaniciAdi) {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost(BaseActivity.NEREDESIN_ARKADAS_LISTELE_URL);
	...
	public static String arkadasEkle(String kullaniciAdi, String arkadasKullaniciAdi) {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost(BaseActivity.NEREDESIN_ARKADAS_EKLE_URL);
			...
			Log.d(TAG, "Arkadas eklenirken hata olustu", e);
		} finally {
			if (in != null) {
				try {
					in.close();
	...
	public static String konumKaydet(Konum konum) {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost(BaseActivity.NEREDESIN_KONUM_KAYDET_URL);
			...
			Log.d(TAG, "Konum kaydedilirken hata olustu", e);
		} finally {
			if (in != null) {
				try {
					in.close();
	...
	public static List<Konum> konumSorgula(String kullaniciAdi) {
		...
		try {
			...
			HttpClient client = new DefaultHttpClient();
			HttpPost request = new HttpPost(BaseActivity.NEREDESIN_KONUM_SORGULA_URL);
	...
	private static List<Konum> getKonumListInputStream(InputStream content) {
		...
		try {
			...
			Log.d(TAG, "Konum XML parse edilirken hata olustu", e);
		}
